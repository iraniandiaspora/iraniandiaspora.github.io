...
<div id="global" class="tab-content">
  <iframe 
    data-src="https://idd-ucla.shinyapps.io/page_6_grid_app/"
    width="100%" 
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (globalContent) {
        ...
        // Load the iframe for the initially visible Global tab
        const iframe = globalContent.querySelector('iframe');
...
function showTab(tabName, element) {
    ...
    if (selectedTab) {
        ...
        // Load iframe if this tab has one and it hasn't been loaded yet
...
function showSubTab(subTabId, element) {
    ...
    if (subTabContent) {
        ...
        // Load iframe if this subtab has one and it hasn't been loaded yet
        const iframe = subTabContent.querySelector('iframe');
        if (iframe && !iframe.src && iframe.dataset.src) {
            iframe.src = iframe.dataset.src;
        }
    }
