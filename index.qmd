...
/* --- Consistent pane + iframe heights --- */
/* Pane padding: 15px top + 40px bottom = 55px */
/* 1020 (iframe) + 55 (padding) = 1075 */
.tab-content {
  display: none;
  ...
  color: #333;
  margin-top: 0;
  min-height: 1075px;  /* consistent pane height */
}
.tab-content.active { display: block; }

.tab-content iframe {
  height: 1020px !important;  /* consistent iframe height */
  width: 100%;
  border: none;
}
...
<div id="bibliography" class="tab-content">
  ...
  <iframe id="iframe-bibliography" src="https://idd-ucla.shinyapps.io/idd_bib/" sandbox="allow-scripts allow-same-origin allow-forms allow-popups"></iframe>
</div>
