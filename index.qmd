...
.submenu {
  ...
  box-sizing: border-box;
  display: none; /* hidden until US tab is active */
}
.submenu-wrapper {
  max-width: 100%;
  margin: 0 auto;
...
<div id="canada" class="tab-content">
  <iframe
    id="iframe-canada"
    src="https://idd-ucla.shinyapps.io/canada_grid_app/?v=20250827"
    width="100%"
    style="border:none; height:850px;">
  </iframe>
</div>
...
function showTab(tabName, element) {
  ...
  if (tabName === 'united-states') {
    ...
    // Auto-open "Defining the Population"
    const popBtn = document.querySelector('.sub-tab[data-tab="population"]');
    if (popBtn) {
      popBtn.classList.add('active');
      showSubTab('population', popBtn);
    }
  } else {
...
/* United States sub-tab controller */
