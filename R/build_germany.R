...
for (LANG in c("en", "fa")) {
  ...
  mig_grid <- paste0(
    ...
    '<div style="font-size:18px; font-weight:600; color:#333; text-align:center;">', tr("de_gen_box_title"), '</div>',
  ...
  pop_body <- paste0(
    ...
    '<div style="margin:18px auto 0; max-width:460px; font-size:13px; color:#444; text-align:left; line-height:1.7; background:#f5f8fb; border:1px solid #dbe6f0; border-radius:6px; padding:13px 16px;">',
  ...
  workinc_body <- paste0(
    ...
    <div style="font-size:15px; font-weight:500; color:#333; margin-top:12px; line-height:1.45;">%s</div>',
      wi1_big, wi1_prim),
    sprintf('    <ul style="margin:12px auto 0; padding-left:18px; max-width:420px; text-align:left; font-size:13px; color:#555; line-height:1.55;">
      <li>%s</li>
      <li>%s</li>
      <li>%s</li>
    </ul>
