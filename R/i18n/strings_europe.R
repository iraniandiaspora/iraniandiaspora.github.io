...
STR <- list(
  ...
  eu_ts_src = list(
    en = "Source: %s (Sweden, Netherlands, Austria, Italy, Norway, Finland) &middot; Statistics Denmark register (Denmark; Eurostat&rsquo;s series ends 2022) &middot; ONS/NRS/NISRA censuses 2001, 2011, 2021/22 (United Kingdom, dotted) &middot; INSEE census, narrower “immigré” definition, through 2019 (France, dashed) &middot; BFS register (Switzerland, dashed). Germany is omitted: Eurostat publishes no Iran-born count for Germany — see the Germany pages.",
    fa = "منبع: %s (سوئد، هلند، اتریش، ایتالیا، نروژ، فنلاند) &middot; سامانه ثبت اداره آمار دانمارک (دانمارک؛ سری Eurostat در 2022 پایان می‌یابد) &middot; سرشماری‌های ONS/NRS/NISRA در 2001، 2011 و 2021/22 (بریتانیا، خط‌چین نقطه‌ای) &middot; سرشماری INSEE با تعریف محدودتر «immigré»، تا 2019 (فرانسه، خط‌چین) &middot; سامانه ثبت BFS (سوئیس، خط‌چین). آلمان کنار گذاشته شده است: Eurostat شمار متولدان ایران را برای آلمان منتشر نمی‌کند — صفحه‌های آلمان را ببینید."),
