...
for (LANG in c("en", "fa")) {
  ...
  body <- paste0(
    ...
    '<p style="margin-bottom:8px;">', tr("eu_idbox_intro"), '</p>',
    '<ul style="padding-left:20px; margin:0; line-height:1.5;">',
    '<li><strong>', EUROSTAT_LINK, '</strong> <span style="color:#6b6b6b;">',
      sprintf(tr("eu_idbox_b1_span"), n_eurostat_box), '</span></li>',
    '<li><strong>', MIKRO_LINK, '</strong> <span style="color:#6b6b6b;">',
      tr("eu_idbox_b2_span"), '</span></li>',
    '<li><strong>', ONS_LINK, ', ', NRS_LINK, ', ', NISRA_LINK, '</strong> <span style="color:#6b6b6b;">',
      tr("eu_idbox_b3_span"), '</span></li>',
    '<li><strong>', BFS_LINK, '</strong> <span style="color:#6b6b6b;">',
      tr("eu_idbox_b4_span"), '</span></li>',
    '</ul>',
    '</div>',
    '</div>',
