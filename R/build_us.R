...
make_butterfly_educ <- function(df_raw, gen_label, age_collapse = FALSE, height = "500px", id_prefix = "ed") {
  ...
  # Stacking order: Graduate first (closest to center), Less than BA last (outermost)
  # Colors match original: lightest=Graduate, darkest=Less than BA
...
writeLines(page_template("Education", paste0(
  ...
  '<div class="section-title">First Generation: Educational Attainment by Age and Gender</div>',
  make_butterfly_educ(e1$gen_1_wide, "1st Generation", FALSE, "500px", "ed1"),
  '</div>',
  '<div class="chart-card">',
  '<div class="section-title">Second Generation: Educational Attainment by Age and Gender</div>',
...
writeLines(page_template("Work", paste0(
  ...
  '<div class="chart-row">',
  '<div class="chart-card">',
  '<div class="section-title">First Generation: Employment by Age and Gender</div>',
  make_butterfly_work(ec$class, "1st gen", "1st Generation", FALSE, "500px", "wk1"),
  '</div>',
  '<div class="chart-card">',
  '<div class="section-title">Second Generation: Employment by Age and Gender</div>',
...
make_income_chart <- function(df, gen_val, gen_label, id_prefix) {
  ...
  p <- plot_ly(data = d, x = ~label, y = ~share, type = "scatter", mode = "markers+lines",
    ...
    add_trace(x = decile_labels, y = rep(10, 10), type = "scatter", mode = "lines",
      ...
      hoverinfo = "skip", showlegend = FALSE) %>%
    layout(
      title = list(text = sprintf("<b>Position in U.S. Income Distribution:<br>%s (Ages 25-54)</b>", gen_label),
        font = list(size = 16, family = "Montserrat")),
...
<div class="headline">
  ...
  <div style="margin:14px auto 0; max-width:440px; font-size:13px; color:#444; text-align:left; line-height:1.7;">
    ...
    <ul style="padding-left:20px; margin:0; line-height:2;">
      ...
      <li><strong>Race</strong> <span style="color:#888;">&mdash; &ldquo;Iranian&rdquo; written in under &ldquo;White&rdquo; (2024 only)</span></li>
